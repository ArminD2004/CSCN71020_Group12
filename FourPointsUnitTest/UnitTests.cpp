...
namespace UnitTests
{
	...
	public:
		...
		TEST_METHOD(TestPointsNotValidRectangle2)
		{
			struct POINTS TestPoint[4];
		...
		TEST_METHOD(TestPointsIfParallelogram)
		{
			struct POINTS TestPoint[4];
		...
		TEST_METHOD(TestPointsIfTrapezoid)
		{
			struct POINTS TestPoint[4];
		...
		TEST_METHOD(TestRectangleWithEqualSides)
		{
			struct POINTS TestPoint[4];
		...
		TEST_METHOD(TestRectangleIfThin)
		{
			struct POINTS TestPoint[4];
